...
Open **http://localhost:4317**. Allow microphone access when you start a session. A quiet room and headphones help. Changes to `.env` or server code require restarting `npm run dev`; frontend changes reload automatically.
